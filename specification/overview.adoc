...
domain and a single hosting supervisor domain can be supported (for example <<dep3>>, 
other deployment models are also possible).
...
as required by implementations. For example <<appendix_d>> shows the TSM and TSM-driver
