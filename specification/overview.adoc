...
(Smmtt) is agnostic of the number of supervisor domains. On processors with 
hypervisor mode that 
do not support Smmtt, a single confidential supervisor domain and a single
non-confidential supervisor domain can be supported (see <<depd>> ).
