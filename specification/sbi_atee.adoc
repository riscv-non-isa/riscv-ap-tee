...
=== Function: TEE Interrupt Bind AIA IMSIC Begin (FID #5)
[source, C]
-------
...
=== Function: TEE Interrupt Bind AIA IMSIC End (FID #6)
[source, C]
-------
...
intrinsic is used by a TVM component to build the chain of trust for the TVM to 
