...
Note that the vCPU creation procedure is not required for TVMs created
using `sbi_covg_promote_to_tvm()` because TSM reuses the vCPUs number defined in the
...
=== Function: COVE Guest Add MMIO Region (FID #1)
[source, C]
-------
...
=== Function: COVE Guest Remove MMIO Region (FID #2)
[source, C]
-------
...
=== Function: COVE Guest Share Memory Region (FID #3)
[source, C]
-------
...
=== Function: COVE Guest Unshare Memory Region (FID #4)
[source, C]
-------
...
=== Function: COVE Guest Allow External Interrupt (FID #5)
[source, C]
-------
...
=== Function: COVE Guest Deny External Interrupt (FID #6)
[source, C]
-------
...
=== Function: COVE Guest Get Attestation Capabilities (FID #7)
[source, C]
-------
...
=== Function: COVE Guest Extend Measurement (FID #8)
[source, C]
-------
...
=== Function: COVE Guest Get Evidence (FID #9)
[source, C]
-------
...
=== Function: COVE Guest Retrieve Secret (FID #10)
[source, C]
-----
...
=== Function: COVE Guest Read Measurement (FID #11)
[source, C]
-------
