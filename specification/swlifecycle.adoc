...
VMM must invoke `sbi_covh_add_tvm_measured_pages()` which extends the initial measurement
...
the page and the GPA selected by the VMM are measured into the TVM (initial) measurement. 
