...
creating non-confidential VMs implemented by existing OS/VMMs. To promote a VM to a TVM, the 
...
and begins to interact with the TVM via the TSM, as described in next sections.
