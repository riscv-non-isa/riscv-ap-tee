...
:description: :description: Confidential VM Extension (CoVE) for Confidential Computing on RISC-V platforms
:company: RISC-V.org
:revdate: 4/2024
:revnumber: 0.6
...
include::threatmodel.adoc[]
include::refarch.adoc[]
include::attestation.adoc[]
include::swlifecycle.adoc[]
