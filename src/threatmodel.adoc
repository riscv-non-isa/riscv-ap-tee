...
6+^| **Description**
6+a| A privileged host software component leaks TVM confidential data via
        use of performance monitoring or debug mechanisms as a side-channel. 
...
| In scope
| Logical or physical component controlled by the TVM
  causes denial of service of the platform.
